...
- Any other spaces representing the ChimeraLM community
...
As ChimeraLM is a bioinformatics research tool working with genomic data, we additionally expect:

- **Responsible data handling**: Follow institutional and legal requirements for genomic data
- **Transparency**: Clearly document methods, limitations, and appropriate use cases
- **Reproducibility**: Share code and methods to enable verification of results
- **Proper attribution**: Credit original authors, datasets, and prior work appropriately
- **Ethical use**: Use ChimeraLM for legitimate research purposes in compliance with ethical guidelines
